        ...
        <main class="max-w-lg mx-auto">
            ...
            <div class="mb-6">
                ...
                <input type="email" name="email" id="email" value="{{ old('email') ?? $user?->email }}"
                    class="border border-gray-400 rounded p2 w-full" required readonly />
                @error('email')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-6">
                ...
                <input type="password" name="password" id="password" class="border border-gray-400 rounded p2 w-full"
                    required />
                @error('password')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
